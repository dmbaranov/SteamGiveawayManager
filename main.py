...
You may face a problem when some bot's just won't do everything.
Because this is a multithreading manager, you should just increase amount of threads.
Best way is to have amount of threads that is equal to amount of bots.

This is beta release.

PACKAGE = "steambots_manager"
